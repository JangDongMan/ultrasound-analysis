# ============================================================
# VB5K Boundary Marker - Fetch files from server
# Usage:
...
param(
    ...
    [string]$RemoteDir  = "~/work/ultrasound_analysis/utils2",
...
Write-Host " VB5K Boundary Marker - Fetch from server"  -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  Build exe  : .\build_marker.bat"
    Write-Host "  Run direct : py -3 boundary_marker_gui.py"
} else {
    Write-Host ""
